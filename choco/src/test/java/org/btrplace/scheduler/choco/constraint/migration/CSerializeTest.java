...
public class CSerializeTest {
    ...
    public void test() {
        ...
        // Register the Serialize constraint
        ps.getConstraintMapper().register(new CSerialize.Builder());
        ...
        // Add the Serialize Constraint
        cstrs.add(new Serialize(vms));
